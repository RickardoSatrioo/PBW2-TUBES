    ...
    <div style="max-width: 1920px; max-height: 1080px; margin: 0 auto; overflow: hidden; position: relative;">
        ...
        <div style="min-height: 100vh; width: 100%; font-family: Arial, sans-serif; padding-top: 5rem; background: #f8f9fa;">
            ...
            <div x-data="{ openTab: 1 }" style="flex-grow: 1; padding: 2rem 3rem 0 2rem; background-color: #ffffff;">
                ...
                <!-- Tab content -->
                <div x-show="openTab === 1" style="margin-top: 20px; padding-right: 1rem; display: none; height: 69vh; overflow-y: auto; overflow-x: hidden;" x-cloak>
                    @for ($i = 1; $i <= 5; $i++)
                    <div style="display: flex; justify-items: center; justify-content: space-between; margin-bottom: 1rem;">
                        <div style="display: flex; gap: 0.75rem;">
                            <div style="width: 10rem; height: 10rem; background-color: #484848; border-radius: 0.8rem; overflow: hidden;">
                ...
                <div x-show="openTab === 2" style="margin-top: 20px; padding-right: 1rem; display: none; height: 69vh; overflow-y: auto; overflow-x: hidden;" x-cloak>
                    @for ($i = 1; $i <= 5; $i++)
                    <div style="display: flex; justify-items: center; justify-content: space-between; margin-bottom: 1rem;">
                        <div style="display: flex; gap: 0.75rem;">
                            <div style="width: 10rem; height: 10rem; background-color: #484848; border-radius: 0.8rem; overflow: hidden;">
